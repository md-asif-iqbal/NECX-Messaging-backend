...
// GET /api/messages?userId=&q=&before=&limit=
...
router.patch('/:id', ensure([optionalBoolean('pinned')]), async (req, res, next) => {
try {
const { id } = req.params
const patch = {}
...
const updated = await Message.findByIdAndUpdate(id, patch, { new: true, runValidators: true })
